...
const VERSION := 16     # v16: THE DUELIST — FLOW=AGGRO (taunt DELETED, passive flow/peel), tank class bulwark->duelist (Bulwark kept as sim fixture). v15: THE DESCENT REBUILD — 4-floor FLOORS (Vorathek=F1 Seal, rings 3-2-1-0), new node kinds (elite/market/jailbreak/minigame/wild + stubs), Prior layer deleted (V#8), claim drops `prior`. v14: net-layer integrity hash — `ih` rides beside `cs` every 30 ticks (seat HP/resource/absorb + rng stream; audit option b). v13: THE PURGE — Voidcaller/Mender/Reckoner deleted; caster=Alchemist, healer=Well(default)/Bloomweaver; gates gone. v12: blade class toggle (dead). v11: THE KILL SWITCH — ⏻ charge + OVERCLOCK arm/cash-out at a Seal
