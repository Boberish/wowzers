	...
	"mercy_terminal": {
		...
		"choices": [
			{"label": "Unplug it — mercy", "kind": "free",
				"fx": {"charge": 18, "entropy": 1, "flag": "freed_daemon",
	...
	"do_not_unplug": {
		...
		"choices": [
			...
			{"label": "Help it mop instead — mercy", "kind": "free",
				"fx": {"entropy": 1, "flag": "janitor_friend",
	...
	"performance_review": {
		...
		"choices": [
			{"label": "Ace the self-review", "kind": "check",
				...
				"success": {"fx": {"entropy": 1, "charge": 6}, "result": "FLAWLESS, NO NOTES. A complimentary med-spray dispenses."},
			...
			{"label": "Flash your reserve of luck", "kind": "free", "gate": {"entropy": 4},
				"fx": {"charge": 10, "tokens": 1,
					"result": "The kiosk mistakes a fat ⚡ reserve for seniority and waves you through with a coupon."}},
