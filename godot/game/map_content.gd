...
const EVENTS := {
	...
	"overtime_daemon": {
		...
		"choices": [
			...
			{"label": "Bill it for your time", "kind": "check",
				"check": {"verb": "OUTBID", "tags": ["rage", "momentum"], "base": 40, "per": 9},
				"fx": {"tokens": 2, "result": "You send an invoice."},
				"success": {"fx": {"tokens": 4, "entropy": 1},
					"result": "Out-lawyered, it triples your invoice and throws in a fistful of chaos."},
				"fail": {"fx": {"wound": 0.06},
					"result": "It logs your extortion and pays the base rate. A sector corrupts in the paperwork."}},
