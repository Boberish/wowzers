...
func _raid_state(seed: int) -> CombatState:
	...
	(s.seats[0].policy as DuelistPolicy).latency_ticks = 5
...
func _initialize() -> void:
	...
	# (Voidcaller kick-heal + Bulwark Bloodthirst lifesteal sub-tests retired 2026-07-10 —
	# THE PURGE + the Bulwark deletion; the Well/Twinfang heal-metering paths carry it now.)
