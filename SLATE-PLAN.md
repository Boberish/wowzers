...
| 2 | Tank · **Duelist** | challenger slate | `TANK-PLAN.md` new § | 🔄 | 07-10 01:00 | Deck v1 (Headsman/Ironside/Ghost + Dancer) is AT BILL'S BOARD → it is **PITCH #0**; challengers must beat it. Flag clearly so it enriches, not muddies, the open verdict. |
