...
PROBES=(
  draft_sim commander_probe market_probe curse_probe map_sim raid_map_sim map_check_sim
  ...
  fermata_input_check fightlen_probe pack_probe packroll_probe world_probe shell_probe artv2_probe
)
