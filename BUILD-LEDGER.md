...
| **GRAPHICS DIRECTION V2 — AI-owned modular visual system** | 🟡 **P5/I3 ACTIVE — board revision 2.** P4 DONE through C5.1; C6A graybox 🔨 `2b407c4`; I3-A material family accepted. Current revision locks central-primary Wind above smaller combo sockets, HP/Aggro side bars, no baked Aggro marker, all three purple feint shapes, barred-disc BRACE, and detailed party rows (HP/resource/cast/debuff). C6B waits for Bill's image verdict. | **`GRAPHICS-PLAN.md` §2.3/§2.3.1 · P5 · I3 · C6B** | I3 board: answer/dashboard material language · side HP/Aggro bars · central Wind · smaller clean sockets · repeatable 4–6 abilities · detailed party island · collapsed meter · updated shape/feint key. Timing nail/gate/text/numbers/fills remain code-owned | **Next owner: Codex I3-A revision 2.** Preserve accepted material language; preview only, no `res://`/C6B until Bill approves. Default-off legacy remains complete. |
