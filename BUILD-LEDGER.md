...
| **GRAPHICS DIRECTION V2 — AI-owned modular visual system** | 🟡 **P5: I3-A BOARD APPROVED; I3-B ACTIVE.** P4 DONE through C5.1; C6A graybox 🔨 `2b407c4`; Bill approved I3-A revision 2 and explicitly authorized the production-asset generation pass. The flattened board is direction truth, not a runtime atlas. | **`GRAPHICS-PLAN.md` §2.3/§2.3.1 · P5 · I3 · C6B** | I3-B produces isolated chroma-key/alpha, 9-slice-capable sources with all values/fills/timing/code truth omitted; then Claude C6B performs trim/slice/import/binding/fallback/tests | **Current owner: Codex I3-B.** Claude must not scrape the dark-backed board into shipping textures. Default-off legacy remains complete. |
