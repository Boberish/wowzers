...
| **GRAPHICS DIRECTION V2 — AI-owned modular visual system** | 🟡 **P5/I3 ACTIVE — first visual board authorized.** P4 DONE: C4 `05d9952` · I2 `11bcd4a`+`567adea` · C5 `f91f1b0` · C5.1 `5bb532c`; C6A graybox 🔨 `2b407c4`; Bill approved the smaller ability band + layout gate. Codex I3 now explores the modular painted component family; C6B waits for Bill's image verdict. Owed later: scarf 2-piece asset · idle/dump swings · per-boss scenes · retained scene/pose matrix debt | **`GRAPHICS-PLAN.md` §2.3/§2.3.1 · P5 · I3 · C6B** | I3 first board: answer-frame/dashboard material language · Flow/Aggro/HP/Wind/socket shells · repeatable 4–6 ability slots · top-island frame language; timing nail/gate/text/numbers/fills/answer geometry remain code-owned. C6B later cuts approved components into replaceable runtime textures | **Next owner: Codex I3 visual board.** Preview first; do not enter `res://` or C6B until Bill approves. Purple alone identifies feints. Default-off legacy remains complete. |
