...
| **GRAPHICS DIRECTION V2 — AI-owned modular visual system** | 🟡 **P6 BUILT: C7 🔨 MERGED 2026-07-14 (branch `artv2-c7`, Bill-directed) — VFX runtime + 13/13 transplant; ⚠ Bill's live verdict. P5 FULL ANATOMY REOPENED: I3-C anchor approved; C6C runtime layout copy CLAIMED (Codex, `dash-c6c`).** P5 C6B `28e9b15`; I4 `2baf3fe`; I3-B `801d713`; C6A `2b407c4`. | **`GRAPHICS-PLAN.md` §2.3/§2.4 · P5/P6 · §5·C6C/C7 · I3-C** | C6C: `dash_host_c6a.gd` responsive anatomy · `dash_party_row.gd` · `answer_channel.gd` icon/gate scale · `duelist_gauge.gd` + existing bar/rune scale surfaces · deterministic dashboard tour. C7 remains: VFX runtime/stage/post stack and tours. | Default OFF ⇒ byte-identical. C6C reuses live controls and approved modular pieces; no baked anchor and no legacy-HUD edit. Verify 720p/1080p/ultrawide + `ui_smoke_raid`/Art-V2 probes and re-run C7 VFX tour because it rides the moved live geometry. |
