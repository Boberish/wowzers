...
| Well — module gauges + AI spell-policy | ⏳ | MENDER | `well_gauge.gd`, `well_policy.gd` | Deck built; **AI now casts SKIN + pilots the Vigil hold (`ed358aa`)**. Still owed: AI Meditate/Boiling Over; the module GAUGE renders (Vigil tremble/hold clock, flume/frozen states — exposed in observe, WSLg render = WELL-DRAW-BRIEF S5, deferred). |
